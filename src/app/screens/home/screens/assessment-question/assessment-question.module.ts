...
import { SomeEffect } from './assessment-question-table/assessment-question-table.effects';
...
@NgModule({
	...
	declarations: [AssessmentQuestionComponent, AssessmentQuestionTableComponent],
	entryComponents: [],
	providers: [
		{
...
export class AssessmentQuestionModuleModule {}
