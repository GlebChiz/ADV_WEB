...
export class RoomForGroupPopupComponent extends UnSubscriber implements OnInit, OnChanges {
	...
	public onConfirmAction(): void {
		this._dialogService.close({ ...this.myRoomForm.value });
	}
